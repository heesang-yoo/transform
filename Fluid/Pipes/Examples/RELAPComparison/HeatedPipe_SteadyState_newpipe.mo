...
model HeatedPipe_SteadyState_newpipe
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T source(
    ...
    use_m_flow_in=false)          annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,-50})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_ph sink(
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=90,
        origin={0,70})));
  GenericPipe_MultiTransferSurface_6dof pipe(
    exposeState_b=true,
...
end HeatedPipe_SteadyState_newpipe;
